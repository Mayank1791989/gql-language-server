...
export default class Diagnostics {
  ...
  _updateDiagnostics = () => {
    ...
    // report new errors
    const diagnosticItems: Array<PublishDiagnosticsParams> = [];
    Object.keys(diagnosticsMap).forEach((file: string) => {
...
export function makeLSPDiagnostic(
  ...
  return {
    ...
    severity: gqlErrorSeverityToDiagnosticSeverity(error.severity),
    code: 'syntax',
    source: 'graphql',
  };
}
